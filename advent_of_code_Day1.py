...
# def solve_trebuchet_file(filename):
#     total_sum = 0
...
# print(solve_trebuchet_file('input.txt'))
...
print(solve_trebuchet(input_data)) 
# Change this line at the bottom:
print(solve_trebuchet(input_data[0].strip().split('\n')))
